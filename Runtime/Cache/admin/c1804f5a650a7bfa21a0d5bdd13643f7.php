    ...
    <!-- <div class="QRcode">移动设备访问本页：<br/><br/><img src="<?php echo ($QRcodeUrl); ?>"/></div> -->
                ...
                <div id="Right">
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab">
                        ...
                        <?php if(is_array($list)): foreach($list as $key=>$m): ?><tr align="center" id="<?php echo ($vo["id"]); ?>">
                                <td><?php echo ($m["id"]); ?></td>
                                <td><?php echo ($m["name"]); ?></td>
                                <td><?php echo ($m["code"]); ?></td>
                                <td><?php echo ($m["area_code"]); ?></td>
                                <td><?php echo ($m["citypy"]); ?></td>
                                <td><a href="#" onclick="del()">编辑</a> | <a href="#" onclick="del()">删除</a></td>
