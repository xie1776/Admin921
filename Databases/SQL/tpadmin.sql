...
CREATE TABLE `pa_admin` (
  ...
  PRIMARY KEY (`aid`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='网站后台管理员表';
...
CREATE TABLE `pa_category` (
  ...
  `lang` varchar(10) NOT NULL DEFAULT 'zh-cn',
  PRIMARY KEY (`cid`)
) ENGINE=InnoDB AUTO_INCREMENT=57 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='新闻分类表';
...
-- ----------------------------
INSERT INTO `pa_member` VALUES ('351', null, null, 'zhibin3@qq.com', '是是非非', '76c2fed3b2ece2e2c56df34db830e86d', null, null, '0', null, null, null, null, null, null, null, null, null, null, null, null, null, '15201412883', '', null, '448188161', '', null, null);
